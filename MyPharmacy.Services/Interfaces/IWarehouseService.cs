...
public interface IWarehouseService
{
    ...
    Task<IResult<IAsyncEnumerable<Warehouse>>> GetWarehouseListAsync();
    ...
    Task<IResult<Warehouse>> InsertWarehouseAsync(Warehouse newWarehouse);
    ...
    Task<IResult<Warehouse>> UpdateWarehouseAsync(Warehouse updatedWarehouse);
    ...
    Task<IResult<Warehouse>> GetWarehouseByIdAsync(int id);
}