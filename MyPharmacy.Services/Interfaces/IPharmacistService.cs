...
public interface IPharmacistService
{
    ...
    Task<IResult<IPagedResult<Pharmacist>?>> GetPagedPharmacistListAsync(PagingInfo pagingInfo);
    ...
    Task<IResult<Pharmacist?>> GetPharmacistByIdAsync(int id);
    ...
    Task<IResult<IEnumerable<Pharmacist>?>> GetPharmacistListByPharmacyIdAsync(int pharmacyId);
    ...
    Task<IResult<Pharmacist?>> UpdatePharmacistAsync(Pharmacist pharmacist);
    ...
    Task<IResult<Pharmacist?>> AddPharmacistAsync(Pharmacist pharmacist);
}